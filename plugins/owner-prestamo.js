...
let texto = `*_🌠 El Owner @${m.sender.split`@`[0]} Necesita Dinero y a hecho un préstamo a su staff ৎ୭࠭͢SonicBot𓆪͟͞ _*\n*➪ Motivo*: ${text}*`
m.reply('*_🚀 Enviando mensaje de reunión a todos los owners de Sonicbot._*')
